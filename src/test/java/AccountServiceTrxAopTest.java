...
import org.orh.service.AccountServiceTrxAop;
...
@ContextConfiguration("classpath:META-INF/spring/beans-trx-aop.xml")
public class AccountServiceTrxAopTest {
     ...
     */
    @Resource
    private AccountServiceTrxAop accountServiceTrxAop;
    ...
    public void testTransfer() {
        ...
        accountServiceTrxAop.transfer("Bob", "Smith", 100d, false);
    ...
    public void testTransferRollback() {
        ...
        try {
            ...
            accountServiceTrxAop.transfer("Bob", "Smith", 100d, true);
        } finally {
            System.out.println("after transfer:");
            printAccountBalance();
        }
    ...
    public void testTransferMultiThreadRollback() {
        ...
        try {
            // throw runtime exception
            accountServiceTrxAop.transferMultiThread("Bob", "Smith", 100d, true);
        } finally {
            System.out.println("after transfer:");
            printAccountBalance();
        }
    ...
    public void printAccountBalance() {
        Double bobBalance = accountServiceTrxAop.getAccountBalance("Bob");
        Double smithBalance = accountServiceTrxAop.getAccountBalance("Smith");
